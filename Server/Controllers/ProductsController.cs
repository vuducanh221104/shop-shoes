...
namespace Server.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        // GET: api/Products/search?q=nike&page=1&pageSize=10&sortBy=featured&category=men&minPrice=100000&maxPrice=2000000
        [HttpGet("search")]
            ...
            [FromQuery] string? brand = null)
        {
            if (string.IsNullOrWhiteSpace(q) && string.IsNullOrWhiteSpace(category) && 
                string.IsNullOrWhiteSpace(brand) && !minPrice.HasValue && !maxPrice.HasValue)
            {
        ...
        public async Task<ActionResult<Product>> PostProduct(ProductCreateDto productDto)
        {
            try
            {
                ...
                var product = new Product
                {
                    ...
                    PriceDiscount = productDto.PriceDiscount ?? productDto.Price,
        ...
        public async Task<IActionResult> PutProduct(int id, ProductCreateDto productDto)
        {
            try
            {
                ...
                product.PriceDiscount = productDto.PriceDiscount ?? productDto.Price;
